...
I went back to making a table with maketrans and using that table to translate the userMessage into the ciphered text. I feel like I've read enough of this shit now that I understand how these are supposed to work.
